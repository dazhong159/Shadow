...
import com.baidu.mobads.sdk.api.XNativeView.INativeViewClickListener;
...
public class BDNativeResponseAdapter implements NativeUnifiedADData, ADEventListener {
  ...
  @Override
  public void bindAdToView(Context context, final NativeAdContainer container,
  ...
  public void bindMediaView(MediaView mediaView, VideoOption videoOption, NativeADMediaListener nativeADMediaListener) {
    ...
    videoView.setNativeViewClickListener(new INativeViewClickListener() {
      @Override
