...
import com.baidu.mobads.sdk.api.NativeResponse.AdDislikeListener;
...
public class BDNativeExpressAdDataAdapter extends NativeExpressADView implements ADEventListener {
  ...
  public BDNativeExpressAdDataAdapter(Context context, final NativeResponse data) {
    super(context);
  ...
  private View getView() {
    ...
    // 点击了负反馈渠道的回调
    response.setAdDislikeListener(new NativeResponse.AdDislikeListener() {
      @Override
